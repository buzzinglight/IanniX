...
QT_MOC_LITERAL(3, 29, 12), // "openExamples"
QT_MOC_LITERAL(4, 42, 5) // "parse"

    },
    "InterfaceSerial\0portChanged\0\0openExamples\0"
    "parse"
};
...
void InterfaceSerial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<InterfaceSerial *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject InterfaceSerial::staticMetaObject = { {
    ...
    qt_meta_stringdata_InterfaceSerial.data,
    qt_meta_data_InterfaceSerial,
    qt_static_metacall,
    nullptr,
    nullptr
} };
