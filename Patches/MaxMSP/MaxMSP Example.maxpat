...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 534.928589, 102.5, 159.734619, 20.0 ],
					"text" : "iannix_object",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 532.928589, 120.5, 380.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 544.928589, 36.5, 359.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 397.928589, 359.0, 170.0, 20.0 ],
					"text" : "pack f f"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 731.428589, 294.0, 151.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 599.816284, 277.0, 137.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 707.428589, 296.0, 24.0, 20.0 ],
					"text" : "Hz",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 639.428589, 296.0, 24.0, 20.0 ],
					"text" : "Hz",
					"textcolor" : [ 0.563657, 0.563657, 0.563657, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 672.428589, 296.0, 43.0, 20.0 ],
					"triangle" : 0,
					"varname" : "flonum[1]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 604.428589, 296.0, 43.0, 20.0 ],
					"triangle" : 0,
					"varname" : "flonum"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 692.428589, 334.0, 151.0, 64.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 267.510193, 112.0, 128.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 554.428589, 60.0, 203.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 322.816345, 6.0, 92.408142, 24.0 ],
					"text" : "Play / pause"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 537.428589, 6.0, 88.0, 24.0 ],
					"text" : "Fastrewind"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"outlinecolor" : [ 0.235294, 0.235294, 0.235294, 0.0 ],
					"patching_rect" : [ 523.428589, 8.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 410.714294, 8.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 523.428589, 60.0, 31.0, 20.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 491.224487, 60.0, 31.0, 20.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 459.020416, 60.0, 31.0, 20.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 394.612244, 112.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 298.0, 35.0, 244.428589, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 356.816345, 9.0, 43.0, 18.0 ],
					"text" : "set $1"
				}
