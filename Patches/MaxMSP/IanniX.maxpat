...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 479.0, 99.0, 398.0, 20.0 ],
					"text" : "IanniX send trigger_id trigger_xPos trigger_yPos trigger_zPos cursor_id",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 528.0, 128.0, 81.0, 20.0 ],
