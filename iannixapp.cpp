...
void IanniXApp::setHelp() {
    ...
    Help::categories["commands"].infos << HelpInfo(QString("add"),
                                           tr("Adding an object"),
                                           tr("Adds an object on the score, but does not specify its position (by default, the object is set on (0,0,0)). The key word auto automatically assigns an ID to your object."),
                                           tr("add <objet> <id>"),
    ...
    Help::categories["commands"].infos << HelpInfo(QString("remove"),
                                           tr("Deleting an object"),
                                           tr("Deletes an object in the score thanks to its ID."),
                                           tr("remove <target>"),
                                           QString("remove 1"),
    ...
    Help::categories["commands"].infos << HelpInfo(QString("setGroup"),
                                           tr("Defining a group"),
                                           tr("Groups are identified by a number or word you are free to choose. Objects are not required to be part of a group."),
    ...
    Help::categories["commands"].infos << HelpInfo(QString("setActive"),
                                           tr("Enabling/disabling an object"),
                                           tr("An object is enable by default, but you can disable it."),
    ...
    Help::categories["commands"].infos << HelpInfo(QString("setTriggerOff"),
                                           tr("Time before release (note off)"),
                                           tr("When a note is played thanks to a trigger, you can configure it to turn the note off automatically after a configurable delay. Controlling the off-time in the message allows the time to be controlled some score variables, changing as the score plays. The time before release should normally be set to zero when note-off time is not being sent in the messages of this trigger."),
    ...
    Help::categories["commands"].infos << HelpInfo(QString("setCurve"),
                                           ...
                                           tr("After creating your cursor, make sur you have assigned the curve you want it to follow. You can use the keyword lastCurve to designate the last curve added."),
    ...
    Help::categories["commands"].infos << HelpInfo(QString("toggleGroup"),
                                           ...
                                           tr("Description"),
                                           tr("toggleGroup <group name>\n") +
                                           tr("toggleGroup <group name> <0|1>\n"),
    ...
    /*
    Help::categories["commands"].infos << HelpInfo(QString("pushSnapshot"),
                                           tr(""),
                                           tr(""),
                                           tr(""),
                                           QString(""),
    ...
    Help::categories["commands"].infos << HelpInfo(QString("popSnapshot"),
                                           tr(""),
                                           tr(""),
                                           tr(""),
                                           QString(""),
